function [trainedClassifier, validationAccuracy] = quadDiscr(trainingData)
% [trainedClassifier, validationAccuracy] = quadDiscr(trainingData)
...
partitionedModel = crossval(trainedClassifier.ClassificationDiscriminant, 'CVPartition', cvp);
