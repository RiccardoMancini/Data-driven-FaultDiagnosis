function [trainedClassifier, validationAccuracy] = kernelNB(trainingData)
% [trainedClassifier, validationAccuracy] = kernelNB(trainingData)
...
partitionedModel = crossval(trainedClassifier.ClassificationNaiveBayes, 'CVPartition', cvp);
