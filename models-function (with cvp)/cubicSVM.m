function [trainedClassifier, validationAccuracy] = cubicSVM(trainingData)
% [trainedClassifier, validationAccuracy] = cubicSVM(trainingData)
...
partitionedModel = crossval(trainedClassifier.ClassificationSVM, 'CVPartition', cvp);
