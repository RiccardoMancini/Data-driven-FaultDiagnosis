function [trainedClassifier, validationAccuracy] = ensBagTrees(trainingData)
% [trainedClassifier, validationAccuracy] = ensBagTrees(trainingData)
...
partitionedModel = crossval(trainedClassifier.ClassificationEnsemble, 'CVPartition', cvp);
