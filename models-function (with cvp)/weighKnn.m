function [trainedClassifier, validationAccuracy] = weighKnn(trainingData)
% [trainedClassifier, validationAccuracy] = weighKnn(trainingData)
...
partitionedModel = crossval(trainedClassifier.ClassificationKNN, 'CVPartition', cvp);
